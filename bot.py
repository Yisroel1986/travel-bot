...
def schedule_no_response_job(context: CallbackContext, chat_id: int):
    ...
    job_queue.run_once(no_response_callback,NO_RESPONSE_DELAY_SECONDS,chat_id=chat_id,name=f"no_response_{chat_id}",data={})
...
def analyze_intent(text: str)->str:
    if nlp_uk:
        ...
        pos={"так","добре","да","ok","продовжувати","розповісти","готовий","готова","привіт","hello","зацікавити","зацікавлений"}
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if s is not None and u is not None:
        t="Ви маєте незавершену розмову. Бажаєте продовжити з того ж місця чи почати заново?\nВідповідайте: 'Продовжити' або 'Почати заново'."
